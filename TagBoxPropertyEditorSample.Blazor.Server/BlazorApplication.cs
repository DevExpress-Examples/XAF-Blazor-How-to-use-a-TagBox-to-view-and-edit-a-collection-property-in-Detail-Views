...
using TagBoxPropertyEditorSample.Blazor.Server.Services;

namespace TagBoxPropertyEditorSample.Blazor.Server {
    public partial class TagBoxPropertyEditorSampleBlazorApplication : BlazorApplication {
        public TagBoxPropertyEditorSampleBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void TagBoxPropertyEditorSampleBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
